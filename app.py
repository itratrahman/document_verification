...
# Configure file logging (separate from MongoDB inference logs)
# Ensure logs directory exists
log_dir = Path("logs")
log_dir.mkdir(exist_ok=True)

# Create file handler with designated filename
...
# Add file handler to logger (keeps console logging from Uvicorn)
logger.addHandler(file_handler)
logger.setLevel(logging.INFO)

logger.info(f"Application logging initialized - writing to {log_filename}")
